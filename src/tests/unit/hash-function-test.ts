...
module('Unit | functions | getHash', function () {
  test('md5 works', async function (assert) {
    ...
    const hash = await getHash(file, AlgorithmType.MD5, loader);
  ...
  test('sha1 works', async function (assert) {
    ...
    const hash = await getHash(file, AlgorithmType.SHA1, loader);
  ...
  test('crc32 works', async function (assert) {
    ...
    const hash = await getHash(file, AlgorithmType.CRC32, loader);
